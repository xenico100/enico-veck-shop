...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f8fbff] px-4 text-stone-900">
      <div className="flex w-full max-w-sm flex-col gap-5 rounded-[0.2rem] border border-stone-900/10 bg-[#f8fbff] p-5 shadow-none sm:gap-6 sm:p-8">
        ...
        <button 
          ...
          className="flex min-h-12 items-center justify-center gap-3 rounded-[0.2rem] border border-stone-900/10 bg-[#f8fbff] px-4 py-3 text-center text-sm font-semibold text-stone-900 transition hover:bg-[#edf3ff] sm:text-base"
        >
          {/* 구글 G 로고 SVG */}
