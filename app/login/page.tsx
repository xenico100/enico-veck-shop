...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[linear-gradient(180deg,#fffdfa_0%,#f7efe5_100%)] px-4 text-stone-900">
      <div className="flex w-full max-w-sm flex-col gap-5 rounded-[0.2rem] border border-stone-900/10 bg-[rgba(255,252,248,0.96)] p-5 shadow-none sm:gap-6 sm:p-8">
        ...
        <button 
          ...
          className="flex min-h-12 items-center justify-center gap-3 rounded-[0.2rem] border border-stone-900/10 bg-[rgba(255,252,248,0.98)] px-4 py-3 text-center text-sm font-semibold text-stone-900 transition hover:bg-[#f4ebe1] sm:text-base"
        >
          {/* 구글 G 로고 SVG */}
        ...
        <form onSubmit={handleAuth} className="flex flex-col gap-4">
          ...
          {!isSignUp && (
            <div className="flex justify-end">
              <button
                ...
                className="inline-flex min-h-11 items-center rounded-[0.2rem] border border-stone-900/10 bg-[rgba(255,252,248,0.98)] px-4 text-sm font-medium tracking-[0.2px] text-stone-800 transition hover:bg-[#f4ebe1] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/20"
              >
          ...
          <button 
            ...
            className="rounded-[0.2rem] border border-red-500/70 bg-red-500 px-4 py-3 text-center text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-black disabled:cursor-not-allowed disabled:border-stone-900/8 disabled:bg-stone-100 disabled:text-stone-400"
          >
