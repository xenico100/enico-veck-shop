...
grant all on public.paypal_customers, public.paypal_plans, public.paypal_subscriptions, public.paypal_webhook_events, public.studio_media, public.studio_access to service_role;
grant select on public.paypal_subscriptions, public.studio_access to authenticated;
