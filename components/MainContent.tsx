...
export default function MainContent() {
  return (
    <section
      id="home"
      className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 md:px-8 text-white max-w-full"
    >
      <div className="text-center mb-8">
        <h1 className="text-7xl md:text-8xl tracking-[0.3em] mb-8">
          ZEUS
        </h1>
