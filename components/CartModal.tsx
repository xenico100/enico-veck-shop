    ...
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={`cart-sheet fixed left-1/2 top-1/2 z-[81] max-h-[calc(100dvh-1rem)] w-[calc(100%-1rem)] max-w-2xl -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[0.2rem] border border-stone-900/10 bg-[rgba(255,252,248,0.98)] shadow-none backdrop-blur-xl outline-none ${appleFontClass}`}
        >
