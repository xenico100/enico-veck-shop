          ...
          <div className="w-full max-w-xl rounded-2xl border border-white/10 bg-neutral-950 p-8 shadow-2xl">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex h-7 w-7 items-center justify-center rounded-full border border-white/10 text-xs text-neutral-400 transition hover:border-pink-400/50 hover:text-white"
              >
