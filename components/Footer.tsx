      ...
      <div className="section-shell">
        <div className="tech-panel grid gap-8 p-5 sm:p-6 md:grid-cols-[1.1fr_0.8fr_0.8fr] md:p-8">
          <div>
            ...
            <h3 className="display-font mt-3 text-[1.55rem] font-semibold tracking-[0.02em] text-white sm:text-[1.9rem]">
              Community Archive
            </h3>
          ...
          <div>
            ...
            <div className="mt-3 space-y-1.5 text-sm text-slate-300/78">
        ...
        <p className="mt-6 text-center text-[11px] tracking-[0.12em] text-slate-400/56 sm:text-xs">
