...
export default function SideMenu({ isOpen, onClose }: SideMenuProps) {
  ...
  useEffect(() => {
    if (!isOpen) setIsMyPageOpen(false);
  }, [isOpen]);
  ...
  return (
    <>
      ...
      {/* Side Menu */}
      <div
        className="fixed right-0 top-0 bottom-0 z-50 w-56 md:w-64 bg-[#0a0a0a] px-6 md:px-12 py-6 md:py-8 transition-transform duration-300 translate-x-0"
        role="dialog"
        aria-modal="true"
      >
